...
insert into question (questionid, question, metricid, require_requirementid) values (1,'Frage1.1',1,1);
insert into question (questionid, question, metricid, require_requirementid) values (2,'Frage1.2',1,1);

insert into question (questionid, question, metricid, require_requirementid) values (3,'Frage2.1',2,2);
insert into question (questionid, question, metricid, require_requirementid) values (4,'Frage2.2',2,2);

insert into question (questionid, question, metricid, require_requirementid) values (5,'Frage3.1',3,3);
insert into question (questionid, question, metricid, require_requirementid) values (6,'Frage3.2',3,3);

insert into question (questionid, question, metricid, require_requirementid) values (7,'Frage4.1',4,4);

insert into question (questionid, question, metricid, require_requirementid) values (8,'Frage4.1',4,5);

insert into question (questionid, question, metricid, require_requirementid) values (9,'Frage5.1',5,6);
